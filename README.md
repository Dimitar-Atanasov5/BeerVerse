...
I manage this project in Jira and Confluence(SRS) and i also use Xray for test managment and monitoring.
...
```bash
git clone https://github.com/Dimitar-Atanasov5/BeerVerse.git
cd BeerVerse
